...
public class Function_01_Test {
    ...
    private Function<Person, Account> personToAccount = pers -> {
    	Account account = new Account();
    	account.setOwner(pers);
    ...
    private Function<Integer, Account> intToAccountWithCompose = i -> {
    	Person person = intToPerson.apply(i);
    	Account account = new Account();
    ...
    private Function<Integer, Account> intToAccountWithAndThen = i -> this.intToPerson.andThen(this.personToAccount).apply(i);
