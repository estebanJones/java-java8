...
public class DateAndTime_02_Test {
    ...
    public void test_localDate_of() {
        ...
        String dateFormat = result.format(formatter);
    ...
    public void test_with() {
        ...
        LocalDate result = localDate.with(ChronoField.DAY_OF_MONTH, 5).with(ChronoField.MONTH_OF_YEAR, 2).with(ChronoField.YEAR, 2015);
